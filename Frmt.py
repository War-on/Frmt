...
while True:
      ...
      if nm == '1' or nm == '01':
            ...
            if result.returncode == 0:
                  ...
                  if ping == 'unknown':
                        print(f'{vm}[x] ERROR: conect a uma rede wi-fi para atualizar a ferramenta.{t}')
                        sleep(5)

                  else:
                        print(f'{vd}[*] Abrindo arquivo para atualizar Ferramenta...{t}')
                        sleep(2)
                        upgradeFrmt.atualizar_Frmt()
            else:
                  print(f'{vm}[x] Error ao verificar conexão.{t}')
                  sleep(5)
