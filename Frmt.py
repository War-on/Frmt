...
while True:
      ...
      if nm == '1' or nm == '01':
            ...
            sleep(3)
            subprocess.run('cd;git clone https://github.com/NuevaGeneracionALB/aleatory-md.git', shell=True)
            input(f'\n{a}Eae, de boa? Vou tentar executar o bot pra voce agora, fica esperto porque se tudo der certo vai ser gerado um QR-code e voce vai precisar de um cell pra escanear, show?{t}\n\n{az}Aperte enter para continuar.{t} ')
            subprocess.run('cd;cd aleatory-md;sh start.sh', shell=True)
            break
      elif nm == '5' or nm == '05':
            animacao()
