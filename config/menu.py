...
{az}|_|     {vm}|_| \_\ {a}|_|  |_| {vd}  |_|  {t}
        ...
        {az}--------{t}[ {az}F{vm}R{a}M{vd}T {a}v.BETA{t} ]{az}--------{t}

Data: {data.strftime('%d/%m/%Y')}  {data.hour}:{data.minute}
...
[{r}04{t}] {a}Bot (Whatsapp){t}      [{r}09{t}] {a}nmap (sqlmap){t}
[{r}05{t}] {a}Personalizar Termux{t} [{r}10{t}] {a}m-wiz (para instalar metasploit){t}

[{vm}97{t}] {a}Instalar Kali Linux{t}
